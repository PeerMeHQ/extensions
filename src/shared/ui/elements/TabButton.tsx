    ...
    {({ selected }) => (
      ...
      >
        <div className="hidden sm:inline-block sm:mr-2">
          <FontAwesomeIcon icon={props.icon} className={clsx('text-lg', selected ? 'opacity-75' : 'opacity-40')} />
        </div>
        <span className="inline-block sm:hidden sm:mr-2">
          <FontAwesomeIcon icon={props.icon} className={clsx('text-xl', selected ? 'opacity-75' : 'opacity-40')} />
        </span>
